...
var buttons = document.querySelectorAll('.features__button');
var featureContent = document.querySelectorAll('.feature__content');
var featureContainer = document.querySelector('.features__buttons__container');
featureContainer.addEventListener('click', function (e) {
  var clicked = e.target.closest('.features__button');
  if (!clicked) return;
